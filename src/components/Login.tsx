...
export default function Login() {
    ...
    if (!session) {
        return (
            <Wrapper>
                <LoginContainer>
                    <Auth view='sign_in' otpType='sms' magicLink showLinks socialLayout='horizontal' providers={['google', 'facebook', 'apple']} redirectTo={`${process.env.NEXT_PUBLIC_DOMAIN}/auth/login`} supabaseClient={supabase} appearance={{
